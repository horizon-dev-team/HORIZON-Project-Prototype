...
/datum/component/payment/proc/handle_cardless(mob/living/user, total_cost)
	...
	playsound(user, 'sound/effects/cashregister.ogg', 20, TRUE, mixer_channel = CHANNEL_UI)
	return TRUE
...
/datum/component/payment/proc/handle_card(mob/living/user, obj/item/card/id/idcard, total_cost)
	...
	playsound(src, 'sound/effects/cashregister.ogg', 20, TRUE, mixer_channel = CHANNEL_UI)
